...
expt.experiment_name='ROC Task Practice'; %Replace this with your experiment name
expt.experiment_code='ROC'; %Replace this with a 3-4 letter code for your experiment
expt.experiment_notes='This is code to run the ROC Task practice'; %Add any pertinent notes here
