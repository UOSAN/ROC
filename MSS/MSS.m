function MSS(tdfile,resource_path,startToggle)
...
experiment_name='Meditation';
experiment_code='Med';  % this should be a short (2-3 letter) code for the experiment
                        % it will be put as part of the data file name
script_revision_date='01/25/11';
...
experiment_notes='This is the script for the four meditation training tasks (ALERT, ANT, SST, and Meditation).';
