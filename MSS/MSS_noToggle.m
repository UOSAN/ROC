...
experiment_name='ALERT';
experiment_code='ALERT';  % this should be a short (2-3 letter) code for the experiment
                        % it will be put as part of the data file name
script_revision_date='10/02/08';
...
experiment_notes='In this iteration of MEMES, we run the TV pitches task and the products task.';
