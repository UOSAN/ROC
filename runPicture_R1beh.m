...
expt.experiment_notes='This is code to run the CHIVES Picture Task R1 beh version'; %Add any pertinent notes here
expt.script_revision_date='5/6/2015'; %Replace with the date you last revised your script
expt.tdfile='PictureR1beh.txt'; %Replace with the name of your td file
