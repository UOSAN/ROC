...
expt.experiment_name='CHIVES Picture Task R2'; %Replace this with your experiment name
expt.experiment_code='PIC'; %Replace this with a 3-4 letter code for your experiment
expt.experiment_notes='This is code to run the CHIVES Picture Task R2 beh version'; %Add any pertinent notes here
expt.script_revision_date='5/6/2015'; %Replace with the date you last revised your script
expt.tdfile='PictureR2beh.txt'; %Replace with the name of your td file
...
expt.default_start='exp_start.jpg'; %Replace if you'd like to use an image other than default_start.jpg
