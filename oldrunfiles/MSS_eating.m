function MSS_eating(tdfile,resource_path,startToggle)
...
default_start = 'default_start.jpg'; % Set the adult and kid start-up images (exp_start.jpg is for non-scanner experiments, default_start.jpg is for scanner)
kid_start = 'kid_start.jpg';

experiment_name='Eating';
experiment_code='Eat';  % this should be a short (2-3 letter) code for the experiment
% it will be put as part of the data file name
script_revision_date='09/08/11';
...
%8/18/08: Customized fields for ALERT
...
%efficiency
%10/12/08: Added 'tag' column in tdfile (can be used to specify
%stimulus categories, or other groupings for later use in analysis)
% 1/25/11: Added "startToggle" option to allow users to change

experiment_notes='This is the script for the eating reappraisal task (EAT).';
