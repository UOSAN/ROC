...
expt.experiment_notes='This is code to run the DEV ROC Task R1 scan version'; %Add any pertinent notes here
expt.script_revision_date='12/13/2017'; %Replace with the date you last revised your script
expt.tdfile='ROC_R1scan.txt'; %Replace with the name of your td file
