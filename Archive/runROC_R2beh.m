...
expt.experiment_notes='This is code to run the DEV ROC Task R2 beh version'; %Add any pertinent notes here
expt.script_revision_date='12/13/2017'; %Replace with the date you last revised your script
expt.tdfile='ROC_R2beh.txt'; %Replace with the name of your td file
expt.resource_path='Resources'; %Replace with the path for your resource folder
expt.output_folder='Output'; %Replace with the path for your output folderexpt.default_start='scan_start.jpg'; %Replace if you'd like to use an image other than default_start.jpg
