...
expt.experiment_name='CHIVES Picture Task Practice'; %Replace this with your experiment name
expt.experiment_code='PIC'; %Replace this with a 3-4 letter code for your experiment
expt.experiment_notes='This is code to run the CHIVES Picture Task Practice'; %Add any pertinent notes here
expt.script_revision_date='5/6/2015'; %Replace with the date you last revised your script
expt.tdfile='PicturePracMock.txt'; %Replace with the name of your td file
expt.resource_path='/Users/sanlab/Desktop/CHIVES/Picture/Resources'; %Replace with the path for your resource folder
expt.output_folder='/Users/sanlab/Desktop/CHIVES/Picture/Output'; %Replace with the path for your output folder
